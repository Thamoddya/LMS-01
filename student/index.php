                                                    ...
                                                    <div class="col-12 col-sm-3 col-lg-3 bg-white rounded-5 m-sm-1 mt-3 mt-md-0">
                                                        <div class="row">
                                                            <div class="col-12 text-start bg-light-subtle">
                                                                <h6 class="m-2 text-center"> ɪꜱꜱᴜᴇᴅ ᴅᴀᴛᴇ
                                                                    : <?php echo date("F j, Y", strtotime($invoices["payedDate"])); ?></h6>
                                                            </div>
                                                            <div class="col-12 text-start"
                                                                 style="background-color: #eff1f3;">
                                                                <h6 class="m-2"><i class="fa fa-user"></i>
                                                                    ᴍᴏɴᴛʜ: <?php echo $invoices["monthName"]; ?></h6>
                                                            </div>
                                                            <div class="col-12 text-start"
                                                                 style="background-color: #eaeaea;">
                                                                <h6 class="m-2"><i class="fa fa-atom"></i> ʏᴇᴀʀ
                                                                    : <?php echo $invoices["yearName"]; ?></h6>
                                                            </div>
                                                            <div class="col-12 text-start"
                                                                 style="background-color: #e5e6e4;">
                                                                <h6 class="m-2"><i class="fa fa-clock"></i> ʙᴀᴛᴄʜ
                                                                    ɴᴀᴍᴇ: <?php echo $student['batchName'] ?></h6>
                                                            </div>
                                                            <div class="col-12 text-start"
                                                                 style="background-color: #cfd2cd;">
                                                                <h6 class="m-2"><i class="fa fa-earth"></i>
                                                                    ᴘʀɪᴄᴇ: <?php echo $invoices["price"]; ?>.00</h6>
                                                            </div>
                                                            <div class="col-12 text-start"
                                                                 style="background-color: #1d3557; height: 50px;">
                                                                <h6 class="m-2 text-white"><i class="fa fa-earth"></i>
                                                                    ɪᴅ : #<?php echo $invoices["invoiceId"]; ?></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <?php
                                                        ...
                                                        <div class="row clearfix">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                                                <input type="text" placeholder="First Name" required=""
                                                                       ...
                                                                       oninput="changeBorderColor(this)">
                                                            </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                                                <input type="text" disabled placeholder="Phone"
                                                                       required="" id="mobile"
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 form-group text-right">
                                                                <button class="theme-btn btn-style-three"
                                                                        id="updateButton"><span class="txt">Update
                                      Details<i class="fa fa-angle-right"></i></span></button>
                                                                <button class="theme-btn btn-style-six"
                                                                        class="btn btn-primary"
                                                                        data-bs-toggle="offcanvas"
                                                                        href="#offcanvasExample" role="button"
                                                                        aria-controls="offcanvasExample"><span
                                                                            class="txt">Update Password<i
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    ...
    <div class="offcanvas-body">
        ...
        <button class="theme-btn btn-style-three" onclick="passwordUpdate();"><span class="txt">Update Password<i
