<table class="table rounded rounded-3">
    ...
    <tbody class="table-group-divider overflow-auto">
        ...
        <?php
        $getStudentDataGet = $pdo->prepare("SELECT * FROM student INNER JOIN batch ON student.batch_batchId = batch.batchId INNER JOIN attendingstatus ON student.attendingStatus_id = attendingstatus.id WHERE verifyed = '0' ");
