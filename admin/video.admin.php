...
<button class="theme-btn mt-2 btn-style-three" onclick="UploadVideo();">Upload Video<i class="fa fa-angle-right"></i>
</button>
<button class="theme-btn mt-2 btn-style-three" onclick="uploadVdieoLink();">Upload Youtube Link<i
            class="fa fa-angle-right"></i></button>

<div class="row mt-3">
    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
        <select class="form-select border-primary" aria-label="Default select example" id="gotSelectedSubject"
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
        <select class="form-select border-primary" aria-label="Default select example" id="loadVideoData"
                onchange="openVideoLink()">
        </select>
    </div>
    ...
    <div class="col-12 mt-1">
        <div class="col-12 mt-1">
            <div class="auto-container">
                ...
                <iframe id="ytVideoFrame" width="640" height="360" src="https://www.youtube.com/embed/erO877oRhJQ"
    ...
    <div class="col-12 mt-2">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                <select class="form-select border-primary" aria-label="Default select example" id="getPrivatevideoData"
                        onchange="loadVideosToBatch();">
                    <?php
        ...
        <button class="theme-btn mt-2 btn-style-three" onclick="UnassignBatchToVideo();">Unassign Video From batch
        </button>
    </div>